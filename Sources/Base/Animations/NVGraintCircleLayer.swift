...
class NVGraintCircleLayer: CALayer {

    override init () {
        super.init()
    }

    convenience init(frame: CGRect, fromColor: UIColor, toColor: UIColor, linewidth: CGFloat, toValue: CGFloat) {
        self.init()
        self.frame = frame
    ...
    func layerWithWithBounds(frame: CGRect, fromColor: UIColor, toColor: UIColor, linewidth: CGFloat,toValue: CGFloat) -> NVGraintCircleLayer {
        let layer = NVGraintCircleLayer(frame: frame, fromColor: fromColor, toColor: toColor,linewidth: linewidth,toValue:toValue)
        return layer
    }
